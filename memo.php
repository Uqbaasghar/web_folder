...
<div class="header">
    ...
    <p style="font-size: 30px;font-family: 'Agency FB';color: black"><b>ADMIRIA</b></p>
    <p style="font-size: 10px;color: black;color: black">Beauty & Frangrances</p>
</div>
...
<footer class="footer-distributed">
    ...
    <div class="footer-center">
        ...
        <div>
            ...
            <p><span>13/24 Main street,Adabor</span>Dhaka, Bangladesh</p>
        </div>
        ...
        <div>
            ...
            <p><a href="mailto:shornojoarder@gmail.com">shornojoarder@gmail.com</a></p>
        </div>
    ...
    <div class="footer-right">
        ...
        <p class="footer-company-about">
            ...
            The company's theme is "Admire Yourself". It was founded on July,2018 by a young & talented entrepreneur, Ms. Jannatun Naima. The company's current worth estimates nearly $13 Billion.
        </p>

        <div class="footer-icons">

            <a href="https://www.facebook.com/shornosmakeover/?timeline_context_item_type=intro_card_work&timeline_context_item_source=100002476951506"><i class="fa fa-facebook"></i></a>
